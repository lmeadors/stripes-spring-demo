...
<stripes:layout-render name="/WEB-INF/bugzooky/layout/standard.jsp" title="Login">
            ...
            <tr>
                ...
                <td style="vertical-align: top;"><c:choose>
                    <c:when test="${empty user}">
                        ...
                        <p>Welcome to Bugzooky, the Stripes demo application. If you haven't already created an account,
                            you will need
                        ...
                        <p><a href="http://stripesframework.org">Stripes</a> is a relatively new framework for
                            developing web
                            applications in Java. It uses an action-oriented model that will be familiar to anyone who
                            has previously used
                            Struts or anything similar. Stripes is designed to be extremely easy to develop with - to be
                            intuitive to
                            developers and to require the minimum amount of code and configuration.</p>

                        <p>As you try out the demo application you can use the links in the footer to view the source of
                            the current
                            JSP, and of other files that are part of the application.</p>
                    </c:when>

                    <c:otherwise>
                        <p>You are already logged in as '${user.username}'. Logging in again will cause you to be logged
                            out, and then
