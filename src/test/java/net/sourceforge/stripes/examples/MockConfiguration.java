...
public class MockConfiguration extends RuntimeConfiguration {
	 ...
	 * Mock Provisions *
	 */
	protected Map<Class<? extends ConfigurableComponent>, ConfigurableComponent> substitutes = new HashMap<Class<? extends ConfigurableComponent>, ConfigurableComponent>();
